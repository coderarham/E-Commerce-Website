          ...
          <div className="space-y-8 text-main">
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                <p className="text-secondary"><strong>Email:</strong> returns@shoecollection.com</p>
                <p className="text-secondary"><strong>Phone:</strong> (+91) 12345 67890</p>
                <p className="text-secondary"><strong>Hours:</strong> Monday - Friday, 9 AM - 6 PM</p>
                <p className="text-secondary"><strong>Address:</strong> Shoe Collection Returns, India</p>
              </div>
            </section>
